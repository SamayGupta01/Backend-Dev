...
console.log(str.replace("Samay","Rahul")); // it will replace first string with second string
console.log(str.replaceAll("Samay","Rahul")); // it will replace all occurence of first string with second string
...
console.log(str.startsWith("Sa")); // it will return true if string starts with given substring
